...
//   if (!res.success) {
//     return { errors: { _form: [res.message ?? "Failed to mark notification as read."] } }
//   }
...
// export async function markAllNotificationsReadAction(): Promise<ActionState<MarkReadData>> {
//   const accessToken = await getAccessToken()
...
//   const response = await apiFetch.patch("/notifications/read-all", { accessToken })
//   const res = await parseResponse<MarkReadData>(response)

//   if (!res.success) {
//     return { errors: { _form: [res.message ?? "Failed to mark all as read."] } }
//   }
...
//   const response = await apiFetch.delete(`/notifications/${notificationId}`, {
//     accessToken,
//   })
...
//   if (!res.success) {
//     return { errors: { _form: [res.message ?? "Failed to delete notification."] } }
//   }
