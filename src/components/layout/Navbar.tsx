...
//     // Single source of truth: Become Host only shows when nobody is logged in.
...
//                     <li className="flex justify-center border-t border-white/5 pt-4">
//                         <HeaderActions user={user} onNavigate={() => setIsOpen(false)} />
//                     </li>
//                 </ul>
//             </nav>
//         </header>
