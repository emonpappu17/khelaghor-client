...
// // Centralize the role -> dashboard route mapping so it's consistent
// // everywhere this logic might be needed.
...
//   // Logged out: nothing to render here, Navbar already shows "Sign in"
//   // separately if you want it — but keeping a single sign-in entry point
//   // avoids duplicate auth CTAs on mobile vs desktop.
//   if (!user) {
//     return (
//       <Link
//         href="/login"
//         onClick={onNavigate}
//         className="rounded-lg px-4 py-2 text-sm font-bold uppercase tracking-wide text-on-surface-variant transition hover:bg-white/5 hover:text-white"
//       >
//         Sign in
//       </Link>
//     )
...
//         onClick={onNavigate}
//         aria-current={pathname === "/user/notifications" ? "page" : undefined}
//         className="relative inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/5 bg-surface-container text-on-surface-variant transition hover:bg-white/5 hover:text-white"
//         aria-label="Notifications"
//       >
//         <HugeiconsIcon icon={Notification01Icon} strokeWidth={2} className="size-5" />
//         {unreadCount > 0 && (
...
//       <DropdownMenu>
//         <DropdownMenuTrigger asChild>
//           <button className="inline-flex items-center gap-2 rounded-lg border border-white/5 bg-surface-container px-2 py-1.5 transition hover:bg-white/5">
//             <Avatar className="h-8 w-8 rounded-lg">
//               <AvatarImage src={user.avatar || undefined} alt={user.name} />
//               <AvatarFallback className="rounded-lg">{initials}</AvatarFallback>
//             </Avatar>
//             <span className="hidden max-w-[120px] truncate text-sm font-medium text-on-surface-variant sm:inline">
//               {user.name}
//             </span>
//             <HugeiconsIcon
//               icon={UnfoldMoreIcon}
//               strokeWidth={2}
//               className="ml-1 size-4 text-on-surface-variant"
//             />
//           </button>
//         </DropdownMenuTrigger>
...
//             <Link href={dashboardHref} className="flex w-full items-center">
//               <HugeiconsIcon icon={DashboardSquare01Icon} strokeWidth={2} className="mr-2 size-4" />
//               Dashboard
//             </Link>
//           </DropdownMenuItem>
...
//           <DropdownMenuItem asChild>
//             <Link href="/profile" className="flex w-full items-center">
//               <HugeiconsIcon icon={UserIcon} strokeWidth={2} className="mr-2 size-4" />
//               Profile
//             </Link>
//           </DropdownMenuItem>
...
//           <DropdownMenuItem asChild>
//             <Link href="/settings" className="flex w-full items-center">
//               <HugeiconsIcon icon={Settings02Icon} strokeWidth={2} className="mr-2 size-4" />
//               Settings
//             </Link>
//           </DropdownMenuItem>
