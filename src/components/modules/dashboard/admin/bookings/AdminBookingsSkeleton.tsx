    ...
    return (
        <div className="space-y-6 animate-pulse">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
                {/* Tabs */}
                <div className="flex bg-surface-container border border-border/10 rounded-xl p-1 shrink-0 w-full md:w-auto overflow-x-auto">
                    {[1, 2, 3, 4, 5].map((idx) => (
                        <div key={idx} className="h-8 w-20 md:w-24 rounded-lg bg-surface-container-high m-0.5 shrink-0" />
                    ))}
                </div>
                ...
                <Table>
                    <TableHeader className="bg-surface-container-low border-b border-border/10">
                        <TableRow className="hover:bg-transparent">
                            <TableHead className="h-12"><Skeleton className="h-4 w-24 bg-surface-container-high" /></TableHead>
                            <TableHead className="h-12"><Skeleton className="h-4 w-28 bg-surface-container-high" /></TableHead>
                        ...
                        {[1, 2, 3, 4, 5].map((rowIdx) => (
                            <TableRow key={rowIdx} className="border-b border-border/10 hover:bg-transparent">
                                ...
                                <TableCell className="py-3 text-right">
                                    <Skeleton className="h-8 w-8 rounded-lg ml-auto bg-surface-container-high" />
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
